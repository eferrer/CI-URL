  ...
  <div id="wrapper"> <!-- wrapper begins-->
    ...
    <header id="headerContainer"> <!--logo and menu container begins-->
      ...
      <nav id="navBar"> <!--navigation bar begins-->
        <ul id="menu">
          <li class="home"><a href="indexUpdate.html">Home</a></li>
          <li class="about"><a href="aboutUpdate.html">About Me</a></li>
          <li class="classtimes"><a href="classesUpdate.html">Classes</a></li>
    ...
    <footer><!--footer begins-->
      <section id="footerLinks"><!--social and contact links begins-->
        ...
        <ul >
          <li class="connect"><a  href="connect.html"><span class="text">Connect with Us</span></a></li>
          <li class="contactUs"><a href="contact.html"><span class="text">Contact Me</span></a></li>
        </ul>
        </article>
